...
// Do not inject a page-world <script> here. TikTok's effective CSP correctly
// blocks inline execution, while the clean UA and Client-Hints are already set
// by the main-process session request hooks.
