...
contextBridge.exposeInMainWorld('etherx', {
  ...
  ai: {
    ...
    getPythonDepsStatus: () => ipcRenderer.invoke('ai:getPythonDepsStatus'),
  ...
  app: {
    ...
    getWhisperLiveStatus: () => ipcRenderer.invoke('app:getWhisperLiveStatus'),
    ensureWhisperLiveRunning: () => ipcRenderer.invoke('app:ensureWhisperLiveRunning'),
